...
class WebsiteUser(HttpUser):
    ...
    def get_user_info(self):
        self.client.get("/v2/user/burdepost")
    ...
    def user_update(self):
        self.client.put("/v2/user/burdepost", json=Data.user_create_payload(), headers=Data.headers_payload())

    @task
    def user_delete(self):
        self.client.post("/v2/user", json=Data.user_create_payload())
        self.client.delete("/v2/user/burdepost")
